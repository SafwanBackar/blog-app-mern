            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    <div className="sm:w-full lg:max-w-3xl">
                        <h2 className="text-left text-2xl font-bold leading-9 tracking-tight text-gray-900 mb-4">Edit your New Blog</h2>
                        <div className="mb-4">
                        <label htmlFor="title" className="block text-sm font-medium leading-6 text-gray-900">Title</label>
                            <input value={title} onChange={handleTitleChange} id="title" name="title" type="text" required className="mt-2 block w-full lg:w-3/4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                        </div>
                        <div>
